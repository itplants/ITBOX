...
//console.log(Date()+' '+'/home/pi/src/ITBOX/oneDayLog.js '+yesterday());

// 45:59:23 make oneday csv data
var job = schedule.scheduleJob( '45 59 23 * * *' , function(){
	...
	console.log('oneDayCron done');
        //result =  execSync('/home/pi/src/ITBOX/oneDayLog.js '+yesterday());
	});
});
